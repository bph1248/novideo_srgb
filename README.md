This fork includes a small addition in the form of a new command-line arg: --silent. When called with this arg, novideo_srgb will apply its config and immediately exit, without displaying a GUI.
